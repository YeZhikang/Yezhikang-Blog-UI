            ...
            return data.map(item => {
                if (typeof item === 'object') {
                    if (item instanceof Array) {
                        return `<div class="pjfont" style="display: inline-block;margin-right: 6px">[ ${ item.toString() } ]</div>`
                    } else {
                        return `<div class="pjfont" style="display: inline-block;margin-right: 6px"> ${ JSON.stringify(item) } </div>`
                    }
                } else {
                    return `<div class="pjfont" style="display: inline-block;margin-right: 6px">${ item.toString() }</div>`
                }
